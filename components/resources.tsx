      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-uncut-sans">Resources to help you get the most out of Kat Pool</h2>
          </div>
          {/* Content */}
          <div>
            {/* Category buttons */}
                  ...
                  <div className={`${category === '1' && 'rotate-2'}`}>
                    <button className={`relative font-medium px-3 py-1.5 bg-gray-800 rounded-full inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:rounded-full ${category === '1' ? 'shadow-lg shadow-blue-500/25 before:via-gray-300' : 'before:via-gray-600'}`} onClick={() => setCategory('1')}>
                      <div className="flex items-center justify-center">
                        <svg className={`w-3 h-3 shrink-0 fill-customPrimary mr-2 ${category === '1' && 'fill-white'}`} viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className={`transition duration-150 ease-in-out ${category === '1' ? 'text-customPrimary' : 'text-gray-400 group-hover:text-gray-300'}`}>Get Support</span>
                      </div>
                    </button>
                  </div>
                )}
                {category && (
                  <div className={`${category === '2' && 'rotate-2'}`}>
                    <button className={`relative font-medium px-3 py-1.5 bg-gray-800 rounded-full inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:rounded-full ${category === '2' ? 'shadow-lg shadow-blue-500/25 before:via-gray-300' : 'before:via-gray-600'}`} onClick={() => setCategory('2')}>
                      <div className="flex items-center justify-center">
                        <svg className={`w-3 h-3 shrink-0 fill-customPrimary mr-2 ${category === '2' && 'fill-white'}`} viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 0a6 6 0 1 0 0 12A6 6 0 0 0 6 0Zm0 9a3 3 0 1 1 0-6 3 3 0 0 1 0 6Z" fillRule="nonzero" />
                        </svg>
                        <span className={`transition duration-150 ease-in-out ${category === '2' ? 'text-customPrimary' : 'text-gray-400 group-hover:text-gray-300'}`}>Learn to Mine</span>
                      </div>
                    </button>
                  </div>
                )}
                {category && (
                  <div className={`${category === '3' && 'rotate-2'}`}>
                    <button className={`relative font-medium px-3 py-1.5 bg-gray-800 rounded-full inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:rounded-full ${category === '3' ? 'shadow-lg shadow-blue-500/25 before:via-gray-300' : 'before:via-gray-600'}`} onClick={() => setCategory('3')}>
                      <div className="flex items-center justify-center">
                        <svg className={`w-3 h-3 shrink-0 fill-customPrimary mr-2 ${category === '3' && 'fill-white'}`} viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className={`transition duration-150 ease-in-out ${category === '3' ? 'text-customPrimary' : 'text-gray-400 group-hover:text-gray-300'}`}>Miner Hosting</span>
                      </div>
                    </button>
                  </div>
                )}
                {category && (
                  <div className={`${category === '4' && 'rotate-2'}`}>
                    <button className={`relative font-medium px-3 py-1.5 bg-gray-800 rounded-full inline-flex m-2.5 group before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:rounded-full ${category === '4' ? 'shadow-lg shadow-blue-500/25 before:via-gray-300' : 'before:via-gray-600'}`} onClick={() => setCategory('4')}>
                      <div className="flex items-center justify-center">
                        <svg className={`w-3 h-3 shrink-0 fill-customPrimary mr-2 ${category === '4' && 'fill-white'}`} viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className={`transition duration-150 ease-in-out ${category === '4' ? 'text-customPrimary' : 'text-gray-400 group-hover:text-gray-300'}`}>Shop Miners</span>
                      </div>
                    </button>
                  </div>
                )}
            ...
            <div className="max-w-sm mx-auto sm:max-w-none grid gap-12 sm:grid-cols-2 md:grid-cols-4 sm:gap-x-6 sm:gap-y-8 items-start">
              ...
              {category && (
                ...
                >
                  <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                    <svg className="fill-customSecondary group-hover:fill-gray-200 transition duration-150 ease-in-out" width="26" height="18" xmlns="http://www.w3.org/2000/svg">
              ...
              {category && (
                ...
                >
                  <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                    <svg className="fill-customSecondary group-hover:fill-gray-200 transition duration-150 ease-in-out" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="font-uncut-sans text-xl text-gray-100 font-semibold">Neon Other</div>
                </a>
              )}
              {/* 3rd Box */}
              {category && (
                ...
                >
                  <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                    <svg className="fill-customSecondary group-hover:fill-gray-200 transition duration-150 ease-in-out" width="22" height="22" xmlns="http://www.w3.org/2000/svg">
              ...
              {category && (
                ...
                >
                  <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                    <svg className="fill-customSecondary group-hover:fill-gray-200 transition duration-150 ease-in-out" width="24" height="18" xmlns="http://www.w3.org/2000/svg">
              ...
              {category && (
                ...
                >
                  <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                    <svg className="fill-customSecondary group-hover:fill-gray-200 transition duration-150 ease-in-out" width="23" height="23" xmlns="http://www.w3.org/2000/svg">
              ...
              {category && (
                ...
                >
                  <div className="relative h-12 w-12 rounded-full bg-gradient-to-t from-gray-800 to-gray-700 flex items-center justify-center shadow-lg mb-3 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                    <svg className="fill-customSecondary group-hover:fill-gray-200 transition duration-150 ease-in-out" width="22" height="18" xmlns="http://www.w3.org/2000/svg">
